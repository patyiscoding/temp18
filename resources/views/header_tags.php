...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-128045735-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-128045735-1');
</script>
...
<link rel="mask-icon" href="/safari-pinned-tab.svg" color="#ffa93a">
<meta name="msapplication-TileColor" content="#ffa93a">
...
<link href="{{ URL::style('bootstrap.min.css') }}" rel="stylesheet">
