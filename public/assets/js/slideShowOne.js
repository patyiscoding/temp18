        ...
        var e = a("html, body"),
            ...
            h = {
                isExternal: function (a) {
                    ...
                    return "string" == typeof c[1] && c[1].length > 0 && c[1].toLowerCase() !== b.location.protocol ? !0 : "string" == typeof c[2] && c[2].length > 0 && c[2].replace(new RegExp(":(" + {
                        "http:": 80,
                        "https:": 443
                    }[b.location.protocol] + ")?$"), "") !== b.location.host ? !0 : !1
                },
                ...
                isHash: function (a, c) {
                    c = c || b.location.href;
                    var d = a.indexOf("#") > -1 ? !0 : !1,
                        e = h.stripHash(a) === h.stripHash(c) ? !0 : !1;
                    return d && e
                },
                ...
                storePageIn: function (b, c, d, e) {
                    var f = a("<html></html>").append(a(d));
                    return b[c] = {
                        status: "loaded",
                        title: f.find("title").first().text(),
                        html: f.find("#" + e),
                        doc: d
                    }, b
                },
            ...
            i = function (c) {
                if (null !== c.state) {
                    ...
                    f.href === d || h.isHash(d, f.href) || f.load(d, !1)
                }
            },
            j = function (g, i) {
                var j = a(g),
                    ...
                    t = function (a, c, d) {
                        ...
                        var l = !1,
                            ...
                            o = {
                                loaded: function () {
                                    ...
                                    m && l ? m && s(g.url) : j.one(a, function () {
                                        s(g.url), d || p(g.url)
                                    }), c && b.history.pushState({
                                        id: k
                                    }, n[g.url].title, g.url), m && !d && p(g.url)
                                },
                                fetching: function () {
                                    l || (l = !0, j.one("ss.onStartEnd", function () {
                                        ...
                                        n.hasOwnProperty(g.url) && o[n[g.url].status]()
                                    }, 10)
                                },
                                error: function () {
                        ...
                        n.hasOwnProperty(g.url) || q(g), i.onStart.render(j), b.setTimeout(function () {
                            i.scroll && e.scrollTop(0), j.trigger("ss.onStartEnd")
                        }, i.onStart.duration), o[n[g.url].status]()
                    },
                    u = function (b) {
                        var c, d = a(b.currentTarget);
                        h.shouldLoadAnchor(d, i.blacklist, i.hrefRegex) && !m && (b.stopPropagation(), c = h.translate(d.prop("href")), c = i.alterRequest(c), q(c))
                    },
                    v = function (b) {
                        var c = a(b.currentTarget);
                        if (!b.metaKey && !b.ctrlKey && h.shouldLoadAnchor(c, i.blacklist, i.hrefRegex) && (b.stopPropagation(), b.preventDefault(), !y())) {
                            z();
                            var d = h.translate(c.prop("href"));
                            m = !0, l = c.prop("hash"), d = i.alterRequest(d), i.onBefore(c, j), t(d)
                        }
                    },
                    w = function (b) {
                        var c = a(b.currentTarget);
                        if (!c.is(i.blacklist) && (b.preventDefault(), b.stopPropagation(), !y())) {
                            z();
                            var e = {
                                url: c.prop("action"),
                                data: c.serialize(),
                            ...
                            m = !0, e = i.alterRequest(e), "get" === e.type.toLowerCase() && (e.url = e.url + "?" + e.data), i.onBefore(c, j), t(e, d, i.allowFormCaching)
                        }
                    },
                    x = 0,
                    y = function () {
                        var a = null === i.repeatDelay,
                            b = parseInt(Date.now()) > x;
                        return !(a || b)
                    },
                    z = function () {
                        x = parseInt(Date.now()) + parseInt(i.repeatDelay)
                    },
                    A = function (a) {
                        i.anchors && (a.on("click", i.anchors, v), i.prefetch && a.on(i.prefetchOn, i.anchors, u)), i.forms && a.on("submit", i.forms, w)
                    },
                    B = function () {
                        var a = j.prop("class");
                        j.removeClass(a), h.redraw(j), j.addClass(a)
                    };
                return i = a.extend({}, a.fn.smoothState.options, i), null === b.history.state && b.history.replaceState({
                    id: k
                }, c.title, o), h.storePageIn(n, o, c.documentElement.outerHTML, k), h.triggerAllAnimationEndEvent(j, "ss.onStartEnd ss.onProgressEnd ss.onEndEnd"), A(j), {
                    href: o,
                    cache: n,
                    clear: p,
                    load: t,
                    fetch: q,
                    restartCSSAnimations: B
                }
            },
            k = function (b) {
        ...
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (a, b, c) {
                ...
                f.version = "1.18.0", k.constructor = f, k.kill()._gc = !1, f.killTweensOf = f.killDelayedCallsTo = c.killTweensOf, f.getTweensOf = c.getTweensOf, f.lagSmoothing = c.lagSmoothing, f.ticker = c.ticker, f.render = c.render, k.invalidate = function () {
                    ...
                    var d, e, f, i, j, k, l, m, n = this._dirty ? this.totalDuration() : this._totalDuration,
                        ...
                        r = this._duration,
                        s = this._rawPrevTime;
                    if (a >= n ? (this._totalTime = n, this._cycle = this._repeat, this._yoyo && 0 !== (1 & this._cycle) ? (this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0) : (this._time = r, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1), this._reversed || (d = !0, e = "onComplete", c = c || this._timeline.autoRemoveChildren), 0 === r && (this._initted || !this.vars.lazy || c) && (this._startTime === this._timeline._duration && (a = 0), (0 === a || 0 > s || s === g) && s !== a && (c = !0, s > g && (e = "onReverseComplete")), this._rawPrevTime = m = !b || a || s === a ? a : g)) : 1e-7 > a ? (this._totalTime = this._time = this._cycle = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== p || 0 === r && s > 0) && (e = "onReverseComplete", d = this._reversed), 0 > a && (this._active = !1, 0 === r && (this._initted || !this.vars.lazy || c) && (s >= 0 && (c = !0), this._rawPrevTime = m = !b || a || s === a ? a : g)), this._initted || (c = !0)) : (this._totalTime = this._time = a, 0 !== this._repeat && (i = r + this._repeatDelay, this._cycle = this._totalTime / i >> 0, 0 !== this._cycle && this._cycle === this._totalTime / i && this._cycle--, this._time = this._totalTime - this._cycle * i, this._yoyo && 0 !== (1 & this._cycle) && (this._time = r - this._time), this._time > r ? this._time = r : 0 > this._time && (this._time = 0)), this._easeType ? (j = this._time / r, k = this._easeType, l = this._easePower, (1 === k || 3 === k && j >= .5) && (j = 1 - j), 3 === k && (j *= 2), 1 === l ? j *= j : 2 === l ? j *= j * j : 3 === l ? j *= j * j * j : 4 === l && (j *= j * j * j * j), this.ratio = 1 === k ? 1 - j : 2 === k ? j : .5 > this._time / r ? j / 2 : 1 - j / 2) : this.ratio = this._ease.getRatio(this._time / r)), o === this._time && !c && q === this._cycle) return void(p !== this._totalTime && this._onUpdate && (b || this._callback("onUpdate")));
                    if (!this._initted) {
